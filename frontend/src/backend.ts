...
export class Backend implements backendInterface {
    ...
    async completeLesson(arg0: SessionKey, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllProgress(arg0: SessionKey): Promise<Array<LessonProgress>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProgress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllProgressSortedByScore(arg0: SessionKey): Promise<Array<LessonProgress>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProgressSortedByScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLessonProgress(arg0: SessionKey, arg1: string): Promise<LessonProgress> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonProgress(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isCompleted(arg0: SessionKey, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async isStarted(arg0: SessionKey, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isStarted(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetProgress(arg0: SessionKey): Promise<void> {
        if (this.processError) {
            try {
    ...
    async startLesson(arg0: SessionKey, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.startLesson(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateScore(arg0: SessionKey, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateScore(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
